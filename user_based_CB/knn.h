...
*/
void knn_euclidean(float* distances, int*& pos_users, float*& dists_users, int n_users, int k, int user_pos){
...
void knn_pearson(float* distances, int*& pos_users, float*& dists_users, int n_users, int k, int user_pos){
  pos_users = new int[n_users]; dists_users = new float[n_users];
